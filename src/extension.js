...
export function activate(context) {
  ...
  console.log(
    'Congratulations, your extension "js-path-refactor" is now active!'
  );
        ...
        .then(function(nextPath) {
          ...
          return vscode.window
            .showInputBox({
              ...
              value: getSrcFolderPath(previousPath)
            })
            .then(searchInPath => {
...
function getSrcFolderPath(path) {
  const search = "src/";
  if (path.indexOf("src/") > -1) {
    const srcString = path.substring(
      0,
